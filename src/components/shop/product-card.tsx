...
export function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <article
      className="group relative overflow-hidden rounded-[1.6rem] border border-white/60 bg-white/82 shadow-soft backdrop-blur-xl transition duration-300 active:scale-[0.985] sm:rounded-[2rem] sm:duration-500 sm:hover:-translate-y-1.5 sm:hover:shadow-lifted"
